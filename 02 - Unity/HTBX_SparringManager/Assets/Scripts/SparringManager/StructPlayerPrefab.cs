...
namespace SparringManager.Structures
{
    ...
    /// </summary>
    [System.Serializable]
    public struct StructPlayerPrefab
    {
        [SerializeField]
        ...
        public StructPlayerPrefab(string name, int operationalArea,StructHitBox structHitBox, StructPlayerScene structPlayerScene, GeneriqueScenarioStruct[] scenarios)
        {
            _name = name;
